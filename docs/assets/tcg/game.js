...
var ASM_CONSTS = {
  25252: () => { if (document.fullscreenElement) return 1; },  
 25298: () => { return document.getElementById('canvas').width; },  
 25350: () => { return parseInt(document.getElementById('canvas').style.width); },  
 25418: () => { document.exitFullscreen(); },  
 25445: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 25518: () => { if (document.fullscreenElement) return 1; },  
 25564: () => { return document.getElementById('canvas').width; },  
 25616: () => { return screen.width; },  
 25641: () => { document.exitFullscreen(); },  
 25668: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 25801: () => { if (document.fullscreenElement) return 1; },  
 25847: () => { return document.getElementById('canvas').width; },  
 25899: () => { return parseInt(document.getElementById('canvas').style.width); },  
 25967: () => { if (document.fullscreenElement) return 1; },  
 26013: () => { return document.getElementById('canvas').width; },  
 26065: () => { return screen.width; },  
 26090: () => { if (document.fullscreenElement) return 1; },  
 26136: () => { return document.getElementById('canvas').width; },  
 26188: () => { return screen.width; },  
 26213: () => { document.exitFullscreen(); },  
 26240: () => { if (document.fullscreenElement) return 1; },  
 26286: () => { return document.getElementById('canvas').width; },  
 26338: () => { return parseInt(document.getElementById('canvas').style.width); },  
 26406: () => { document.exitFullscreen(); },  
 26433: () => { return screen.width; },  
 26458: () => { return screen.height; },  
 26484: () => { return window.screenX; },  
 26511: () => { return window.screenY; },  
 26538: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 26591: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 26662: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 26719: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 26790: () => { if (document.fullscreenElement) return 1; },  
 26836: () => { if (document.pointerLockElement) return 1; }
};
