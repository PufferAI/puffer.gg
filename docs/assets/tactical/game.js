...
// include: /tmp/tmp7ta7wxwj.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/tactical/game.data';
...
Module['FS_createPath']("/resources", "moba", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/tactical/game.data');

      };
      Module['addRunDependency']('datafile_build_web/tactical/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/breakout_weights.bin", "start": 0, "end": 592404}, {"filename": "/resources/connect4_weights.pt", "start": 592404, "end": 622798}, {"filename": "/resources/moba/bloom_shader_100.fs", "start": 622798, "end": 623867}, {"filename": "/resources/moba/bloom_shader_330.fs", "start": 623867, "end": 624938}, {"filename": "/resources/moba/dota_map.png", "start": 624938, "end": 628634}, {"filename": "/resources/moba/game_map.npy", "start": 628634, "end": 645018}, {"filename": "/resources/moba/map_shader_100.fs", "start": 645018, "end": 648598}, {"filename": "/resources/moba/map_shader_330.fs", "start": 648598, "end": 655175}, {"filename": "/resources/moba/moba_assets.png", "start": 655175, "end": 768424}, {"filename": "/resources/moba/moba_weights.bin", "start": 768424, "end": 2288648}, {"filename": "/resources/pong_weights.bin", "start": 2288648, "end": 2823704}, {"filename": "/resources/puffers_128.png", "start": 2823704, "end": 2846610}, {"filename": "/resources/snake_weights.bin", "start": 2846610, "end": 2911654}], "remote_package_size": 2911654});

  })();

// end include: /tmp/tmp7ta7wxwj.js
// include: /tmp/tmppmev5z84.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmppmev5z84.js
// include: /tmp/tmpksy7ogec.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpksy7ogec.js
...
var ASM_CONSTS = {
  26148: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 26201: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); }
};
...
var dynCall_iiiiifi = Module['dynCall_iiiiifi'] = createExportWrapper('dynCall_iiiiifi', 7);
