...
var ASM_CONSTS = {
  24692: () => { if (document.fullscreenElement) return 1; },  
 24738: () => { return document.getElementById('canvas').width; },  
 24790: () => { return parseInt(document.getElementById('canvas').style.width); },  
 24858: () => { document.exitFullscreen(); },  
 24885: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 24958: () => { if (document.fullscreenElement) return 1; },  
 25004: () => { return document.getElementById('canvas').width; },  
 25056: () => { return screen.width; },  
 25081: () => { document.exitFullscreen(); },  
 25108: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 25241: () => { if (document.fullscreenElement) return 1; },  
 25287: () => { return document.getElementById('canvas').width; },  
 25339: () => { return parseInt(document.getElementById('canvas').style.width); },  
 25407: () => { if (document.fullscreenElement) return 1; },  
 25453: () => { return document.getElementById('canvas').width; },  
 25505: () => { return screen.width; },  
 25530: () => { if (document.fullscreenElement) return 1; },  
 25576: () => { return document.getElementById('canvas').width; },  
 25628: () => { return screen.width; },  
 25653: () => { document.exitFullscreen(); },  
 ...
 25873: () => { return screen.width; },  
 25898: () => { return screen.height; },  
 25924: () => { return window.screenX; },  
 25951: () => { return window.screenY; },  
 25978: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 26031: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 26102: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 26159: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 26230: () => { if (document.fullscreenElement) return 1; },  
 26276: () => { if (document.pointerLockElement) return 1; }
};
