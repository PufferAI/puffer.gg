...
var ASM_CONSTS = {
  25172: () => { if (document.fullscreenElement) return 1; },  
 25218: () => { return document.getElementById('canvas').width; },  
 25270: () => { return parseInt(document.getElementById('canvas').style.width); },  
 25338: () => { document.exitFullscreen(); },  
 25365: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 25438: () => { if (document.fullscreenElement) return 1; },  
 25484: () => { return document.getElementById('canvas').width; },  
 25536: () => { return screen.width; },  
 25561: () => { document.exitFullscreen(); },  
 25588: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 25721: () => { if (document.fullscreenElement) return 1; },  
 25767: () => { return document.getElementById('canvas').width; },  
 25819: () => { return parseInt(document.getElementById('canvas').style.width); },  
 25887: () => { if (document.fullscreenElement) return 1; },  
 25933: () => { return document.getElementById('canvas').width; },  
 25985: () => { return screen.width; },  
 26010: () => { if (document.fullscreenElement) return 1; },  
 26056: () => { return document.getElementById('canvas').width; },  
 26108: () => { return screen.width; },  
 26133: () => { document.exitFullscreen(); },  
 26160: () => { if (document.fullscreenElement) return 1; },  
 26206: () => { return document.getElementById('canvas').width; },  
 26258: () => { return parseInt(document.getElementById('canvas').style.width); },  
 26326: () => { document.exitFullscreen(); },  
 26353: () => { return screen.width; },  
 26378: () => { return screen.height; },  
 26404: () => { return window.screenX; },  
 26431: () => { return window.screenY; },  
 26458: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 26511: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 26582: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 26639: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 26710: () => { if (document.fullscreenElement) return 1; },  
 26756: () => { if (document.pointerLockElement) return 1; }
};
