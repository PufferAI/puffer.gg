...
var ASM_CONSTS = {
  24676: () => { if (document.fullscreenElement) return 1; },  
 24722: () => { return document.getElementById('canvas').width; },  
 24774: () => { return parseInt(document.getElementById('canvas').style.width); },  
 24842: () => { document.exitFullscreen(); },  
 24869: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 24942: () => { if (document.fullscreenElement) return 1; },  
 24988: () => { return document.getElementById('canvas').width; },  
 25040: () => { return screen.width; },  
 25065: () => { document.exitFullscreen(); },  
 25092: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 25225: () => { if (document.fullscreenElement) return 1; },  
 25271: () => { return document.getElementById('canvas').width; },  
 25323: () => { return parseInt(document.getElementById('canvas').style.width); },  
 25391: () => { if (document.fullscreenElement) return 1; },  
 25437: () => { return document.getElementById('canvas').width; },  
 25489: () => { return screen.width; },  
 25514: () => { if (document.fullscreenElement) return 1; },  
 25560: () => { return document.getElementById('canvas').width; },  
 25612: () => { return screen.width; },  
 25637: () => { document.exitFullscreen(); },  
 ...
 25857: () => { return screen.width; },  
 25882: () => { return screen.height; },  
 25908: () => { return window.screenX; },  
 25935: () => { return window.screenY; },  
 25962: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 26015: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 26086: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 26143: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 26214: () => { if (document.fullscreenElement) return 1; },  
 26260: () => { if (document.pointerLockElement) return 1; }
};
